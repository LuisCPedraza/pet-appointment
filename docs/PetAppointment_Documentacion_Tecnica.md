...
| ID | Historia de Usuario | Criterios de Aceptación | Story Points |
|---|---|---|---|
| US-20 | Como **cliente**, quiero **recibir una notificación** cuando el estado de mi cita cambie para **estar siempre informado**. | Notificación local en dispositivo al detectar cambio de estado vía Realtime mientras la app está activa | 5 |
...
| US-22 | Como **profesional**, quiero **ser notificado al instante** cuando se registre una nueva cita para **preparar mi agenda con anticipación**. | Notificación local en dispositivo en tiempo real vía Supabase Realtime mientras la app está activa | 3 |
